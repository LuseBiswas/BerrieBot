    ...
    <section ref={ref} className="relative flex items-center justify-center mt-44 z-0">
      ...
      >
        ...
        <div className="flex-1 flex items-center justify-center">
          <Link href="/schedule">
          <motion.button
            className="bg-[#04BBA6] text-black px-8 py-4 rounded-md font-inter font-light text-[16px] hover:bg-[#039a87] transition-colors hover:cursor-pointer relative overflow-hidden w-[180px] h-[56px]"
