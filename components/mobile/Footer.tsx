      ...
      <div className="max-w-sm mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-left">info@berribot.com</p>
          </div>
        </div>
        
        {/* Products */}
        <div className="mb-8">
          <h3 className="text-lg font-medium mb-6 text-left">Products</h3>
        ...
        {/* Solutions */}
        <div className="mb-8">
          <h3 className="text-lg font-medium mb-6 text-left">Solutions</h3>
          <ul className="space-y-4 text-gray-400 text-left">
        ...
        {/* Resources */}
        <div className="mb-8">
          <h3 className="text-lg font-medium mb-6 text-left">Resources</h3>
          <ul className="space-y-4 text-gray-400 text-left">
        ...
        {/* About */}
        <div className="mb-8">
          <h3 className="text-lg font-medium mb-6 text-left">About</h3>
          <ul className="space-y-4 text-gray-400 text-left">
        ...
        {/* Legal */}
        <div className="mb-8">
          <h3 className="text-lg font-medium mb-6 text-left">Legal</h3>
          <ul className="space-y-4 text-gray-400 text-left">
