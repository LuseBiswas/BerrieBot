...
export default function MobileFAQComponent() {
  ...
  return (
    <div className="w-full mb-12 px-4 bg-white pt-10 pb-10">
      <div className="w-full max-w-sm mx-auto space-y-4 mt-10">
        {displayedFAQs.map((item) => (
          <div key={item.id} className="w-full">
            ...
            <div className="flex justify-center">
              ...
              >
                <div className="p-4 flex justify-between items-center h-full">
                  <motion.h3
                    className="font-extralight font-inter flex-1 pr-2"
                    style={{
                      fontSize: '20px',
                      lineHeight: '1.2'
                    }}
            ...
            {/* Answer Container - Slides down below question */}
            <AnimatePresence>
              {expandedId === item.id && (
                <motion.div
                ...
                >
                  <div className="w-[260px] bg-transparent rounded-2xl p-4">
                    <motion.div
                      ...
                      className="text-[#3D3D3D94] leading-relaxed font-inter font-extralight"
                      style={{
                        fontSize: '16px',
                        lineHeight: '1.4'
                      }}
        ...
        {!showAll && faqData.length > 10 && (
          <div className="flex justify-center mt-8">
            <motion.button
              ...
              className="flex items-center justify-center w-12 h-12 bg-[#EAEFEF] rounded-full hover:bg-[#d1d5db] transition-colors duration-300"
      ...
      <div className="text-center mt-16 px-4">
        <h3 className="text-[#9CA3AF] font-extralight font-inter mb-4" style={{ fontSize: '18px' }}>
          Still curious?
        </h3>
        <p className="text-[#9CA3AF] font-extralight font-inter mb-8" style={{ fontSize: '18px' }}>
