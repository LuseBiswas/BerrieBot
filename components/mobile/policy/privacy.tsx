...
interface MobilePrivacyPolicyComponentProps {
  state: 'initial' | 'expanded' | 'confirmation';
  onStateChange?: (state: 'initial' | 'expanded' | 'confirmation') => void;
}

const MobilePrivacyPolicyComponent = ({ state, onStateChange }: MobilePrivacyPolicyComponentProps) => {
...
export default MobilePrivacyPolicyComponent; 